...
class LSTMCell(LayerRNNCell):
  ...
  def call(self, input_smooth, state):
      ...
      '''
      c_attention = sigmoid(self.cro_attn(array_ops.concat([m_prev[:,:2]/30000,m_prev[:,2:]/100], 1), C_filter,c_prev))
      # Backward measure
      lstm_g_l1 = math_ops.matmul(array_ops.concat([c_attention,m_prev[:,:2]/30000,m_prev[:,2:]/10], 1), self._kernel_g_l1)
      ...
      lstm_g_l1_2 = math_ops.matmul(array_ops.concat([c_attention, m_prev[:,:2]/30000,m_prev[:,2:]/10], 1), self._kernel_g_l1_2)
